...
/// <summary>
/// Describes an name/value item to be displayed in a <see cref="PropertyGridExtended{TItem}"/>.
/// </summary>
/// <remarks>
/// <para>
/// Implement this interface to use as the <c>TItem</c> of a <see cref="PropertyGridExtended{TItem}"/> component.
/// </para>
/// <para>
...
/// </para>
/// </remarks>
public interface IPropertyGridExtendedItem
{
    bool IsRequired { get; }
...
public sealed partial class PropertyGridExtended<TItem> where TItem : IPropertyGridExtendedItem
{
